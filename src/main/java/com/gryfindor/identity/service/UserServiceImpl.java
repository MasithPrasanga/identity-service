...
import com.gryfindor.identity.exception.UserExistingException;
import com.gryfindor.identity.model.User;
import com.gryfindor.identity.repository.UserRepository;
import com.gryfindor.identity.util.ExceptionMessage;
...
public class UserServiceImpl implements UserService {
	...
	public UserResponse registerUser(UserRequest userRequest) {
		...
		if (!ObjectUtils.isEmpty(existingUser)) {
			...
			throw new UserExistingException(ExceptionMessage.USER_FOUND.getDescription(), description,
